...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Modification d'une Activité</h1>
                    <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="activityForm">
                            <input type="hidden" id="activite_id" name="activite_id" value="<?php echo $activityId; ?>">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="provider-selector mb-3">
                                    <div class="d-flex justify-content-start align-items-center mb-2">
                                        <div>
                                            <input type="radio" class="form-check-input me-2" id="no_provider" name="provider_option" value="none">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="quote-selector mb-3">
                                    <div class="d-flex justify-content-start align-items-center mb-2">
                                        <div>
                                            <input type="radio" class="form-check-input me-2" id="no_quote" name="quote_option" value="none">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const activityId = document.getElementById('activite_id').value;
        ...
        function loadActivityDetails(activityId) {
            ...
            .then(activity => {
                ...
                if (activity.id_lieu) {
                    const lieuInterval = setInterval(() => {
                        ...
                        if (lieuSelect.options.length > 1) {
                            lieuSelect.value = activity.id_lieu;
                            showLocationDetails(activity.id_lieu);
                ...
                if (activity.id_prestataire) {
                    document.getElementById('id_prestataire').value = activity.id_prestataire;
                    document.getElementById('select_provider').checked = true;
                    document.getElementById('provider_selection_container').style.display = 'block';
                    loadProviders().then(() => {
                        setTimeout(() => {
                            selectProvider(activity.id_prestataire);
                        }, 500);
                    });
                } else {
                    document.getElementById('no_provider').checked = true;
                }

                // Gestion du devis
                if (activity.id_devis) {
                    document.getElementById('id_devis').value = activity.id_devis;
                    document.getElementById('select_quote').checked = true;
                    document.getElementById('quote_selection_container').style.display = 'block';
                    loadQuotes().then(() => {
                        setTimeout(() => {
                            selectQuote(activity.id_devis);
                        }, 500);
                    });
                } else {
                    document.getElementById('no_quote').checked = true;
                }
            })
            .catch(error => {
                console.error('Erreur lors du chargement des détails de l\'activité:', error);
                alert('Erreur lors du chargement des détails de l\'activité');
            });
        }
        ...
        function loadQuotes() {
            ...
            return fetch('../../api/estimate/getAllEstimate.php', {
                headers: {
                    'Authorization': 'Bearer ' + getToken()
                }
            })
        ...
        function updateActivity() {
            ...
            const activityId = form.activite_id.value.trim();
            const nom = form.nom.value.trim();
            const type = form.type.value.trim();
            const date = form.date.value.trim();
            const id_lieu = form.id_lieu.value ? parseInt(form.id_lieu.value) : null;
            ...
            if (id_devis !== null) formData.id_devis = id_devis;
            if (id_prestataire !== null) formData.id_prestataire = id_prestataire;
            ...
            .then(data => {
                if (data && data.success) {
                    ...
                    alert('Erreur lors de la mise à jour de l\'activité: ' + (data.message || 'Veuillez vérifier les données saisies.'));
                }
            })
            .catch(error => {
