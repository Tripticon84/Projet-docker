...
<body>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <div class="d-flex align-items-center">
                        ...
                        <h1 class="h2">Modifier un contrat ou un devis</h1>
                    </div>
                </div>
                ...
                <!-- Formulaire pour Contrat -->
                <div id="contractForm" class="card" style="display: none;">
                    <div class="card-header bg-white">
                        <h5 class="card-title mb-0">Modifier un Contrat</h5>
                    </div>
                    <div class="card-body">
                        <form id="modifyContractForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="id_societe" class="form-label">Société</label>
                                    <input type="number" class="form-control" id="id_societe" name="id_societe">
                                </div>
                            </div>
                ...
                <div id="notFoundMessage" class="alert alert-danger my-4" style="display: none;">
                    ...
                    <p>Le contrat ou devis demandé n'existe pas ou a été supprimé.</p>
                    <hr>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const contractForm = document.getElementById('modifyContractForm');
            const estimateForm = document.getElementById('modifyEstimateForm');

            [contractForm, estimateForm].forEach(form => {
